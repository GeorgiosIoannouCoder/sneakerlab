...
export const createOrder = (order) => async (dispatch, getState) => {
    try{
        ...
        const {data} = await axios.post('/api/orders/add/', order, configurations)
...
export const getOrderDetails = (id) => async (dispatch, getState) => {
    try{
        ...
        const {userLogin: {userInfo}, } = getState()
        const configurations = {headers:{'Content-type':'application/json', Authorization: `Bearer ${userInfo.token}`}}
        const {data} = await axios.get(`/api/orders/${id}/`, configurations)
...
export const payOrder = (id, paymentResult) => async (dispatch, getState) => {
    try{
        ...
        const {userLogin: {userInfo}, } = getState()
        const configurations = {headers:{'Content-type':'application/json', Authorization: `Bearer ${userInfo.token}`}}
        const {data} = await axios.put(`/api/orders/${id}/pay/`, paymentResult, configurations)
...
export const deliverOrder = (order) => async (dispatch, getState) => {
    try{
        ...
        const {userLogin: {userInfo}, } = getState()
        const configurations = {headers:{'Content-type':'application/json', Authorization: `Bearer ${userInfo.token}`}}
        const {data} = await axios.put(`/api/orders/${order._id}/deliver/`, {}, configurations)
...
export const listMyOrders = () => async (dispatch, getState) => {
    try{
        ...
        const {userLogin: {userInfo}, } = getState()
        const configurations = {headers:{'Content-type':'application/json', Authorization: `Bearer ${userInfo.token}`}}
        const {data} = await axios.get('/api/orders/myorders/', configurations)
...
export const listOrders = () => async (dispatch, getState) => {
    try{
        ...
        const {userLogin: {userInfo}, } = getState()
        const configurations = {headers:{'Content-type':'application/json', Authorization: `Bearer ${userInfo.token}`}}
        const {data} = await axios.get('/api/orders/', configurations)
